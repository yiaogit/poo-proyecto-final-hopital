...
> 📌 **Versión actual: v2.0** — incluye CRUD completo, búsqueda por DNI y persistencia de citas. Ver [`CHANGELOG.md`](CHANGELOG.md) para el historial detallado.
...
- 🔍 **Búsqueda y eliminación** por DNI con garantía de unicidad
...
├── 📊 citas_db.csv         # Base de datos de citas (se genera al guardar) ← v2.0
