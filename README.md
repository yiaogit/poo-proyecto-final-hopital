...
- 📥 **Guardado en PDF** vía diálogo nativo del navegador (sin dependencias)
...
├── 📋 requirements.txt     # Flask (única dependencia)
...
Cada documento tiene un botón **"📥 Guardar como PDF"** que abre el diálogo de impresión del navegador con la opción **"Guardar como PDF"** preseleccionable como destino. Esta funcionalidad es **nativa del navegador** y funciona idénticamente en Windows, macOS y Linux **sin instalar ninguna librería adicional**.

Pasos para guardar un documento como PDF:
1. Pulsa **"📥 Guardar como PDF"** → se abre el diálogo de impresión
2. En **"Destino"** elige **"Guardar como PDF"** (Chrome/Edge) o **"PDF"** (Safari/Firefox)
3. Pulsa **"Guardar"** y elige la carpeta de destino

El archivo resultante conserva la identidad visual UEV completa (colores corporativos, logo, tipografías).
...
<details>
<summary><b>¿Cómo guardar un documento como PDF?</b></summary>

Pulsa el botón **"📥 Guardar como PDF"** → en el diálogo que aparece, selecciona **"Guardar como PDF"** (Chrome/Edge) o **"PDF"** (Safari/Firefox) como destino y pulsa "Guardar". Esta función es nativa del navegador y no requiere ninguna instalación adicional.
</details>
