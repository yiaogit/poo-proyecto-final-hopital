...
![Version](https://img.shields.io/badge/version-2.5-blueviolet.svg)
...
> 📌 **Versión actual: v2.5** — incluye búsqueda por ID Colegiado, listado paginado y vista detallada de citas. Ver [`CHANGELOG.md`](CHANGELOG.md) para el historial completo.
...
- 📑 **Listados paginados** (10 por página) con navegación interactiva
- 📅 **Vista detallada de la agenda** integrada en la ficha de cada persona
- 🗑️ **Eliminación de personas** desde CLI y web con confirmación
...
├── 📄 persistencia.py      # GestorDatos (lectura/escritura CSV de pacientes, médicos y citas)
├── 📄 utilidades.py        # LogMixin con sistema de niveles
├── 📄 main.py              # CLI: menú interactivo (7 opciones)
...
│   └── buscar.html
│
├── 📊 pacientes_db.csv     # Base de datos de pacientes (22 registros)
├── 📊 medicos_db.csv       # Base de datos de médicos (12 registros)
├── 📊 citas_db.csv         # Base de datos de citas (se genera al guardar)
