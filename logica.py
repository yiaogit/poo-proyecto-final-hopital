...
class Cita:
    def __init__(self, medico: Medico, paciente: Paciente, fecha_hora: str, motivo: str,
        ...
        Parámetros:
            ...
            validar_pasado : si False, permite crear citas en el pasado
                             (usado solo al restaurar el histórico desde CSV).
        """
        ...
        # Log: solo registramos citas nuevas, no las restauradas desde CSV
        if validar_pasado:
            escribir_log(
                NIVEL_CITA,
