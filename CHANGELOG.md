...
- **Descarga PDF** opcional vía `xhtml2pdf` (parámetro `?format=pdf`).
...
### Cambiado
- **`requirements.txt`** ahora incluye `xhtml2pdf` (opcional, con degradación elegante si no está instalado).
